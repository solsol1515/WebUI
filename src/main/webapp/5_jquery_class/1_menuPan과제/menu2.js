$(function(){
   ...
   $('.menu > img').click(function(){
       winObj = window.open("menu_option2.html", "", "width=600, height=800") // 옵션 선택 화면 띄우기
       let cos = $(opener.document).find('.option').val($(this).val());
		alert(cos);
...
// 메뉴 클릭 시 옵션 선택 화면 띄우기
     /* $('.menus').each(function(){
	  $(this).click(function(){
			//alert('click');
			//winObj = window.open("menu_option2.html", "", "width=600, height=800")
	 })*/
